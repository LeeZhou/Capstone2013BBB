...
public class DropDownDialogController implements Controller {
  ...
  @NiftyEventSubscriber(id="option-5")
  public void onOption5Changed(final String id, final RadioButtonStateChangedEvent event) {
    screen.findNiftyControl("option-5-changed", Label.class).setText(String.valueOf(event.isSelected()));
  }
