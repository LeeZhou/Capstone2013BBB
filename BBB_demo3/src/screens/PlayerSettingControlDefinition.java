 ...
 * @author void
 */
public class PlayerSettingControlDefinition {
  public static final String NAME = "dropDownDialogControl";
  private static CommonBuilders builders = new CommonBuilders();

  public static void register(final Nifty nifty) {
    new ControlDefinitionBuilder(NAME) {{
        controller(new PlayerSettingController());
        control(new ControlBuilder(DialogPanelControlDefinition.NAME) {{
        image(new ImageBuilder("title1") {{
            filename("Interface/title1.png");
        }});
        ...
        panel(new PanelBuilder() {{
          image(new ImageBuilder("numPlayer") {{
            filename("Interface/numberPlayer.png");
            }});
        ...
        image(new ImageBuilder("abtext") {{
          filename("Interface/Abilitytext.png");
        }});
        panel(builders.vspacer());
